    ...
    <div class="modal-content" style="max-width: 500px;">
        ...
        <form method="POST" action="{{ route('absensi.jadwal.store') }}">
            ...
            <div style="padding: 0 20px 20px; display: flex; gap: 10px;">
                <button type="button" class="btn-action btn-danger" style="flex: 1; justify-content: center;" onclick="closeModal('modalAddJadwal')">Batal</button>
                <button type="submit" class="btn-action" style="flex: 1; justify-content: center;">Simpan Jadwal</button>
            </div>
        </form>
    </div>
</div>
...
<div id="modalEditJadwal" class="modal-overlay">
    <div class="modal-content" style="max-width: 500px;">
        ...
        <form id="formEditJadwal" method="POST" action="">
            ...
            <div style="padding: 0 20px 20px; display: flex; gap: 10px;">
                <button type="button" class="btn-action btn-danger" style="flex: 1; justify-content: center;" onclick="closeModal('modalEditJadwal')">Batal</button>
