<section x-show="tab === 'tahunan'" x-transition.opacity class="space-y-8 mb-8" style="display: none;">
    {{-- ─── Hero Card: Ringkasan Keuangan Tahunan ─────────────────────────── --}}
        ...
        <div class="p-6 md:p-8">
            ...
            <div class="flex items-start justify-between gap-4 flex-wrap">
                <div class="flex items-center gap-3">
                    <div class="rounded-lg bg-purple-50 p-2 md:p-3 text-purple-600">
            ...
            <div class="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                <div class="p-4 md:p-5 rounded-xl bg-blue-50 border border-blue-100 flex items-start gap-4 shadow-sm hover:shadow-lg transition-shadow text-blue-600">
                    ...
                    <div>
                        ...
                        <div id="annual-offline-omset-value" class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0</div>
                    </div>
                </div>
                ...
                <div class="p-4 md:p-5 rounded-xl bg-sky-50 border border-sky-100 flex items-start gap-4 shadow-sm hover:shadow-lg transition-shadow text-sky-600">
                    ...
                    <div>
                        ...
                        <div id="annual-online-omset-value" class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0</div>
                    </div>
                </div>
                ...
                <div class="p-4 md:p-5 rounded-xl bg-indigo-50 border border-indigo-100 flex items-start gap-4 shadow-sm hover:shadow-lg transition-shadow text-indigo-600">
                    ...
                    <div>
                        ...
                        <div id="annual-total-omset-value" class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0</div>
                    </div>
                </div>
                ...
                <div class="p-4 md:p-5 rounded-xl bg-amber-50 border border-amber-100 flex items-start gap-4 shadow-sm hover:shadow-lg transition-shadow text-amber-600">
                    ...
                    <div>
                        ...
                        <div id="annual-hpp-value" class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0</div>
                    </div>
                </div>
                ...
                <div class="p-4 md:p-5 rounded-xl bg-emerald-50 border border-emerald-100 flex items-start gap-4 shadow-sm hover:shadow-lg transition-shadow text-emerald-600">
                    ...
                    <div>
                        ...
                        <div id="annual-pemasukan-value" class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0</div>
                    </div>
                </div>
                ...
                <div class="p-4 md:p-5 rounded-xl bg-rose-50 border border-rose-100 flex items-start gap-4 shadow-sm hover:shadow-lg transition-shadow text-rose-600">
                    ...
                    <div>
                        ...
                        <div id="annual-pengeluaran-value" class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0</div>
                    </div>
                </div>
            </div>

            {{-- Laba Kotor + Rugi pills --}}
            <div class="mt-6 flex flex-wrap items-center gap-3 text-sm md:text-base">
                <span class="rounded-full bg-gray-50 text-gray-800 px-3 md:px-4 py-1 md:py-1.5">Laba Kotor: <strong id="annual-laba-kotor-value" class="text-current">Rp 0</strong></span>
                <span class="rounded-full bg-gray-50 text-gray-800 px-3 md:px-4 py-1 md:py-1.5">Rugi: <strong id="annual-rugi-value" class="text-rose-600">Rp 0</strong></span>
            </div>
        </div>
    </article>
    ...
    <section class="overflow-hidden rounded-[1.75rem] border border-gray-100 bg-white shadow-sm">
        <div class="flex items-center justify-between border-b border-gray-50 px-6 py-5">
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">Rincian transaksi tahunan per jenis — klik untuk lihat grafik</p>
            </div>
