<div x-show="tab === 'bulanan'" class="space-y-8 mb-8">
    <!-- Mobile-like monthly summary: white card with mini-cards matching mobile _miniCard style -->
        ...
        <div class="p-6 md:p-8">
            ...
            <div class="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                <div
                    ...
                    <div>
                        ...
                        <div id="monthly-offline-omset-value"
                            class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0</div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <div id="monthly-online-omset-value"
                            class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0</div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <div id="monthly-total-omset-value"
                            class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0</div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <div id="monthly-hpp-value" class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <div id="monthly-pemasukan-value" class="mt-1 text-base md:text-lg font-semibold text-current">
                            Rp 0</div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <div id="monthly-pengeluaran-value"
                            class="mt-1 text-base md:text-lg font-semibold text-current">Rp 0</div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 flex flex-wrap items-center gap-3 text-sm md:text-base">
                <span class="rounded-full bg-gray-50 text-gray-800 px-3 md:px-4 py-1 md:py-1.5">Laba Kotor: <strong
                        id="monthly-laba-kotor-value" class="text-current">Rp 0</strong></span>
                <span class="rounded-full bg-gray-50 text-gray-800 px-3 md:px-4 py-1 md:py-1.5">Laba Bersih: <strong
                        id="monthly-laba-bersih-value" class="text-current">Rp 0</strong></span>
                <span class="rounded-full bg-gray-50 text-gray-800 px-3 md:px-4 py-1 md:py-1.5">Rugi: <strong
                        id="monthly-rugi-value" class="text-current">Rp 0</strong></span>
            </div>
        </div>
    </article>
