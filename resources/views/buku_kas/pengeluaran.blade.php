        ...
        <div style="display: contents;">
            <div class="left-actions-group">
                <div class="search-wrapper">
                    ...
                    <input type="text" id="globalSearch" class="search-input" placeholder="Cari pengeluaran..." onkeyup="filterTable()">
                </div>
            ...
            <div class="right-actions">
                ...
                <button type="button" class="btn-action" onclick="openModal('modalPengeluaran')">
...
<div id="modalPengeluaran" class="modal-overlay">
    <div class="modal-content" style="max-width: 450px;">
        ...
        <form action="{{ route('keuangan.cashflow.store') }}" method="POST" novalidate>
            ...
            <div class="form-group"><label>Keterangan *</label><textarea name="keterangan" id="ketPengeluaran" class="form-control" style="min-height: 80px;" placeholder="Tulis keterangan pengeluaran..." required_js></textarea><div class="invalid-feedback">Keterangan wajib diisi</div><div class="chips-container">@foreach(['Gaji', 'Sewa Tempat', 'Listrik', 'Air', 'Bensin', 'Bahan Baku', 'Lain-lain'] as $sar)<button type="button" class="chip" onclick="document.getElementById('ketPengeluaran').value = '{{ $sar }}'">{{ $sar }}</button>@endforeach</div></div>
            <div style="display: flex; gap: 10px; margin-top: 20px;"><button type="button" onclick="closeModal('modalPengeluaran')" class="btn-action btn-danger" style="flex:1; justify-content:center;">Batal</button><button type="submit" class="btn-action" style="flex:1; justify-content:center;">Simpan</button></div>
        </form>
    </div>
</div>
