        ...
        <div style="display: contents;">
            <div class="left-actions-group">
                <div class="search-wrapper">
                    ...
                    <input type="text" id="globalSearch" class="search-input" placeholder="Cari supplier..." onkeyup="filterTable()">
                </div>
                <div class="dropdown">
            ...
            <div class="right-actions">
                ...
                <button type="button" class="btn-action" onclick="openModal('modalHutang')"><iconify-icon icon="solar:add-circle-bold-duotone"></iconify-icon><span>Tambah Hutang</span></button>
            </div>
        </div>
    </div>
...
<div id="modalHutang" class="modal-overlay">
    <div class="modal-content" style="max-width: 450px;">
        ...
        <form action="{{ route('keuangan.debt.store') }}" method="POST" novalidate>
            ...
            <div class="form-group"><label>Supplier / Kontak *</label><select name="kontak_nama" class="form-control" required_js><option value="">-- Pilih Kontak --</option>@foreach($suppliers as $supplier)<option value="{{ $supplier->nama }}">{{ $supplier->nama }}</option>@endforeach</select><div class="invalid-feedback">Kontak wajib dipilih</div></div>
            <div class="form-group"><label>Total Nilai Hutang *</label><div class="nominal-wrapper"><input type="number" name="nominal" class="form-control" placeholder="0" required_js><div class="invalid-feedback">Nominal wajib diisi</div></div></div>
            ...
            <div style="display: flex; gap: 10px; margin-top: 20px;"><button type="button" onclick="closeModal('modalHutang')" class="btn-action btn-danger" style="flex:1; justify-content:center;">Batal</button><button type="submit" class="btn-action" style="flex:1; justify-content:center;">Simpan</button></div>
        </form>
    </div>
</div>
