            ...
            <div class="bungkus-form">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="grup-input">
                        ...
                        <input type="tel" name="no_hp" id="inputTel"
                            class="field-input @error('no_hp') is-invalid @enderror" placeholder="0812xxxxxxx"
                            value="{{ old('no_hp') }}">
                        @error('no_hp')
                            <span class="pesan-error">{{ $message }}</span>
                        @enderror
                ...
                <p style="margin-top: 30px; text-align: center; font-size: 14px; color: var(--warna-abu);">
                    Sudah punya akun?
                    <a href="{{ route('login') }}"
                        style="color: var(--warna-utama); font-weight: 700; text-decoration: none;">Masuk</a>
                </p>
            </div>
        </div>
    </div>

    <div id="session-data" data-errors="{{ json_encode($errors->all()) }}" data-error="{{ session('error') }}"
